...
exports.selectReviews = (category, sort_by = "created_at", order = "DESC") => {
  ...
  let formatStr = `SELECT reviews. *, COUNT(comments) ::INT AS comment_count FROM reviews LEFT JOIN comments ON comments.review_id = reviews.review_id  JOIN users on reviews.owner = users.username`;
